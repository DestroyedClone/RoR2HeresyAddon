...
namespace HeresyAddon
{
    ...
    public class HeresyAnimsPlugin : BaseUnityPlugin
    {
        ...
        public void Start()
        {
            ...
            //Railgunner
            On.EntityStates.EntityState.PlayAnimationOnAnimator_Animator_string_string_string_float += EntityState_PlayAnimationOnAnimator_Animator_string_string_string_float;
        ...
        {
            orig(self);
            Chat.AddMessage("railgunner muzzlename: " + self.muzzleName);
        }

        private void EntityState_PlayAnimationOnAnimator_Animator_string_string_string_float(On.EntityStates.EntityState.orig_PlayAnimationOnAnimator_Animator_string_string_string_float orig, Animator modelAnimator, string layerName, string animationStateName, string playbackRateParam, float duration)
        {
            orig(modelAnimator, layerName, animationStateName, playbackRateParam, duration);
            if (Input.GetKey(KeyCode.LeftShift))
            {
                Chat.AddMessage($"Animator: {modelAnimator.name} LayerName: {layerName} AnimationStateName: {animationStateName}" +
                    $" PlaybackRateParam {playbackRateParam} Duration {duration}");
            }
        }
