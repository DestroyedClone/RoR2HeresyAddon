...
namespace HeresyAddon
{
    public class LunarPrimary
    {
       ...
       // public static bool stepperLoader = false;
        ...
        {
            self.PlayAnimation("Gesture, Override", "FirePistol", "FirePistol.playbackRate", self.duration);
            //FireNeedle(self, EntityStates.Railgunner.Weapon.FirePistol.muzzleName);
        }
